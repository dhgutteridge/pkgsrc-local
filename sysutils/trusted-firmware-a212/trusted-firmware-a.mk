...
MAKE_FLAGS+=	CC=${PREFIX}/cross-aarch64-none-elf/bin/aarch64-none-elf-gcc
MAKE_FLAGS+=	CPP=${PREFIX}/cross-aarch64-none-elf/bin/aarch64-none-elf-gcc
BUILD_TARGET=	bl31
...
do-install:
	${INSTALL_DATA_DIR} \
	     ${DESTDIR}${PREFIX}/share/trusted-firmware-a212/${PLATFORM}
.if ${BL31_SUFFIX} == "bin"
	${INSTALL_DATA} \
